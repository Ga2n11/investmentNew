...
export default class Main extends Component {
    ...
    render() {
        ...
        if (this.state.user === 1){
            return (
              <div><h1 className="heading">My Investments</h1>
              <h3 className="heading">Easily track your crypto and Stock investments</h3>
                    ...
                    <div className="mainBlock">
                      {form}
                      {
                        ...
                        (<span className="underLine">Not registered? <button onClick={() => this.formSwitcher(!this.state.formSwitcher ? 'register' : 'login')} 
                          ...
                          <span className="underLine">Already a member? <button onClick={() => this.formSwitcher(!this.state.formSwitcher ? 'register' : 'login')} 
